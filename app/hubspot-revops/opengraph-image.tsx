    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: 'flex' }}>HubSpot setup</div>
            <div style={{ display: 'flex' }}>for a cleaner GTM system.</div>
          </div>
          <div
            style={{
              fontSize: '30px',
          ...
          >
            Pipeline design, workflow automation, reporting, and RevOps support
